...
public final class NetworkUtil {
    ...
    private static final BroadcastReceiver
            networkConnectivityChangeReceiver = new BroadcastReceiver() {
        @Override
     ...
     * 注册的网络状态监听器
     */
    private static final List<NetworkConnectivityChangeListener>
            NETWORKCONNECTIVITYCHANGELISTENERLIST = new ArrayList<NetworkConnectivityChangeListener>();
    /**
    ...
    public static void registNetworkConnectivityChangeListener(Context context, NetworkConnectivityChangeListener listener) {
        if (listener != null && !NETWORKCONNECTIVITYCHANGELISTENERLIST.contains(listener)) {
            ...
            if (context != null) {
                registerReceiverSafe(context, networkConnectivityChangeReceiver, new IntentFilter(
